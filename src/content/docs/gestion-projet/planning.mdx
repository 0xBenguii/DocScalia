...
> 📸 **Screenshot à insérer ici** — export du Gantt ClickUp une fois finalisé.
> Placer l'image dans `src/assets/gantt-scalia.png` et décommenter la ligne ci-dessous.
...
> 📸 **Screenshot à insérer ici** — capture du board Kanban ClickUp en cours de sprint.
> Placer l'image dans `src/assets/kanban-scalia.png` et décommenter la ligne ci-dessous.
