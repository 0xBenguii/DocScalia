...
description: Vue d'ensemble de la mise en place des Sites et Services Active Directory pour le projet Scalia - FreeMotions.
---
import {LinkButton, Steps, Badge, Aside, Card, CardGrid, StarlightIcon } from '@astrojs/starlight/components';

## Introduction

Cette section fait suite à la mise en place de l'infrastructure **Active Directory Domain Services** 
...
<Aside type="tip" title="Sites et Services configurés">
  La réplication entre les sites de Paris et Lyon est désormais optimisée. La prochaine étape consiste à définir la **structure de l'Active Directory** en organisant les Unités d'Organisation (OU) pour refléter l'architecture de l'entreprise.
</Aside>
